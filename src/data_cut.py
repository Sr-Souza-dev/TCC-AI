...
def Cut(dataName, size):
    ...
    X_test.to_csv( f'../Data/Cut/dataset1/X/Test_{size[2]}{dataName}.csv',  index=False, sep = ';') 
    Y_test.to_csv( f'../Data/Cut/dataset1/Y/Test_{size[2]}{dataName}.csv',  index=False, sep = ';') 
    ...
    X_test.to_csv( f'../Data/Cut/dataset2/X/Test_{size[2]}{dataName}.csv',  index=False, sep = ';') 
    Y_test.to_csv( f'../Data/Cut/dataset2/Y/Test_{size[2]}{dataName}.csv',  index=False, sep = ';') 
    ...
    X_test.to_csv( f'../Data/Cut/statistic/X/Test_{size[2]}{dataName}.csv',  index=False, sep = ';') 
    Y_test.to_csv( f'../Data/Cut/statistic/Y/Test_{size[2]}{dataName}.csv',  index=False, sep = ';') 
